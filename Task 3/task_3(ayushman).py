...
def set_bot_movement(client_id,wheel_joints,forw_back_vel,left_right_vel,rot_vel):
	...
	sim.simxSetJointTargetVelocity(client_id, wheel_joints[1], 0*forw_back_vel, sim.simx_opmode_oneshot)
	sim.simxSetJointTargetVelocity(client_id, wheel_joints[2], 0*forw_back_vel, sim.simx_opmode_oneshot)
...
def task_3_primary(client_id, target_points):
	...
	set_bot_movement(client_id, wheel_joints,10,0,5)
